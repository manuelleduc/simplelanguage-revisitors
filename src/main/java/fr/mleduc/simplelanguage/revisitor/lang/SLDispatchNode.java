...
public abstract class SLDispatchNode extends Node {
    ...
    protected static Object doDirect(FunDef function, Object[] arguments,
    ...
    protected static Object doIndirect(FunDef function, Object[] arguments,
...
//    }
    ...
    protected static boolean isForeignFunction(TruffleObject function) {
        return !(function instanceof FunDef);
    }
