...
public class SimpleLanguageParser extends Parser {
	...
	public final FactorContext factor() throws RecognitionException {
		...
		try {
			...
			case IDENTIFIER:
				...
				setState(177);
				_localctx.IDENTIFIER = match(IDENTIFIER);
				 Expr assignmentName = factory.createStringLiteral(_localctx.IDENTIFIER, false); 
				setState(183);
				_errHandler.sync(this);
	...
	public static class Member_expressionContext extends ParserRuleContext {
		public Expr r;
		public Expr assignmentReceiver;
		public Expr assignmentName;
		public Expr result;
		public ExpressionContext expression;
		public Token e;
		public Token IDENTIFIER;
		...
		public Member_expressionContext(ParserRuleContext parent, int invokingState, Expr r, Expr assignmentReceiver, Expr assignmentName) {
			super(parent, invokingState);
			this.r = r;
	...
	public final Member_expressionContext member_expression(Expr r,Expr assignmentReceiver,Expr assignmentName) throws RecognitionException {
		...
		try {
			...
			{
			 Expr receiver = r;
			                                                  Expr nestedAssignmentName = null; 
			setState(228);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
			case T__1:
